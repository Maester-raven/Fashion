...
```text
<PROJECT_ROOT>/work_dirs/bcr_mcs_arc_guarded_independent_val200
<PROJECT_ROOT>/work_dirs/bcr_mcs_arc_guarded_loose_val200
```
...
```text
<PROJECT_ROOT>/work_dirs/final_mask_verifier_bcr_mcs_arc_train300_val200
```

Low-threshold completeness veto sweep:

```text
<PROJECT_ROOT>/work_dirs/final_mask_verifier_bcr_mcs_arc_low_veto_eval_val200
```
...
```text
script: <PROJECT_ROOT>/scripts/run_final_mask_verifier_bcr_1000.sh
log:    <PROJECT_ROOT>/logs/final_mask_verifier_bcr_1000.log
pid:    <PROJECT_ROOT>/logs/final_mask_verifier_bcr_1000.pid
output: <PROJECT_ROOT>/work_dirs/final_mask_verifier_bcr_mcs_arc_train1000_val200
```
